...
function OfferTrabajo({ titleC,  description, info, area,  tipo, link, contacto }) {
  return (
    ...
    >   
        ...
        <a href="localhost:3000" className="btn btn-outline-secondary btn-justify-content-end ">
        "Me Interesa"
